...
@section('title', 'Implementing Agency List')
@section('content')
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card card-primary">
          <div class="card-header d-flex justify-content-between align-items-center">
              <h3 class="card-title">Implementing Agency List</h3>
            </div>
            <input type="hidden" id="ministry_id" value="{{$ministryid}}">
          <!-- /.box-header -->
          <div class="card-body">
            <div class="row">
              <div class="col-md-12">
...
<script>
    ...
    var link = '{{route("implementing-agency-list",":id")}}'; 
