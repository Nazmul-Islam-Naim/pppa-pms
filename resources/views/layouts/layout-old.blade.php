                        ...
                        <div class="default-sidebar-menu">
                            <ul>
                                ...
                                <li class="default-sidebar-dropdown {{(
                                    ...
                                    $url==config('app.utility').'/revenue-model' || $url==config('app.utility').'/revenue-model/create' || $url==(request()->is(config('app.utility').'/revenue-model/*/edit'))) ? 'active':''}}">
                                    <a href="javascript::void(0)">
                                ...
                                <li class="default-sidebar-dropdown {{(
                                    ...
                                    $url==config('app.pfu').'/procurement-details' || $url==config('app.pfu').'/procurement-details/create' || $url==(request()->is(config('app.pfu').'/procurement-details/*/edit'))) ? 'active':''}}">
                                    <a href="javascript::void(0)">
                                        <i class="icon-layers2"></i>
