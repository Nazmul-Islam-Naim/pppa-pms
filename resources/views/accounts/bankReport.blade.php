    ...
    <div class="row gutters">
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        ...
        <div class="card card-primary">
          ...
          <div class="card-body">
            <div class="col-md-12">
              <form method="get" action="{{ route('bank-report.filter', $singledata->id) }}" autocomplete="off">
              @csrf
                ...
                <table class="" style="width: 100%; font-size: 12px;" cellspacing="0" cellpadding="0">  
                  ...
                  <tfoot> 
                    <tr> 
                      ...
                      <td style="font-weight: bold; border: 1px solid #ddd; padding: 3px 3px"><b>{{number_format($credit, 2)}}</b></td>
                      <td style="font-weight: bold; border: 1px solid #ddd; padding: 3px 3px"><b>{{number_format($debit, 2)}}</b></td>
