      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
          <div class="card-header">
            <div class="card-title">Recovery Form</div>
          </div>
          {!! Form::open(array('route' =>['recovery.store'],'method'=>'POST','files'=>true)) !!}
          <div class="card-body">
            <div class="col-md-12">
              <div class="form-inline">
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="field-wrapper">
                        <input type="text" name="total_amount" id="total_amount" autocomplete="off" class="form-control" value="{{$single_data->total_amount}}" readonly="">
                        <div class="field-placeholder">Recovery Amount</div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="field-wrapper">
                        <input type="number" name="recover_amount" id="recover_amount" step="any" class="form-control" value="" onkeyup="setValue()" required=""autocomplete="off" >
