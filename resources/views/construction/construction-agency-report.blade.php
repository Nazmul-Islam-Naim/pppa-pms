...
@section('title', 'Construction Agency Report')
@section('content')
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card card-primary">
          <div class="card-header d-flex justify-content-between align-items-center">
              <h3 class="card-title">Construction Agency Report</h3>
            </div>
          <!-- /.box-header -->
          <div class="card-body">
            <div class="row">
   ...
   function dateFormat(data) { 
	...
	$(document).ready(function() {
      ...
      var table = $('#example').DataTable({
			...
			processing: true,
      deferRender : true,
			ajax: "{{route('construction-agency-report')}}",
      ...
      dom: 'Blfrtip',
			...
			columns: [
        {
          ...
          render: function(data, type, row) { 
            if (data != null) {
              var url = '{{route("construction-company-wise-report",":id")}}'; 
              var url = url.replace(':id', row.construction_company_id);
              return "<a href='"+ url +"' data-id='" + row.id + "'>"+data+"</a>";
            } else {
