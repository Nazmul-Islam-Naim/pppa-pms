      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card card-primary">
          <div class="card-header d-flex justify-content-between align-items-center">
              <h3 class="card-title">Phase Report</h3><a onclick="printReport();" href="javascript:0;"><img class="img-thumbnail" style="width:30px;" src='{{asset("custom/img/print.png")}}'></a>
            </div>
          <!-- /.box-header -->
          <div class="card-body">
            <div class="row">
                  ...
                  <table class="table "  style="width:100%"> 
                    <thead> 
                      <tr style="background: #ccc; color: #000"> 
                        ...
                        <td style="border: 1px solid #ddd; padding: 3px 3px" colspan="5">{{$single_data->project->name}}</td>
                      </tr>
                      <tr style="background: #ccc; color: #000"> 
                        <th style="border: 1px solid #ddd; padding: 3px 3px">Phase</th>
                        <td style="border: 1px solid #ddd; padding: 3px 3px" colspan="5">{{$single_data->phase->name}}</td>
                      </tr>
                      <tr style="background: #ccc; color: #000"> 
                        <th style="border: 1px solid #ddd; padding: 3px 3px">Phase</th>
                        <td style="border: 1px solid #ddd; padding: 3px 3px" colspan="5">{{$single_data->subphase->name}}</td>
                      </tr>
                      <tr style="background: #ccc; color: #000"> 
