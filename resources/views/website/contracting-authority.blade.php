...
<div>
    <div class="container mt-5">
        <h5>PPP Contracting Authority List</h5>
    <hr>
    </div>
</div>
<div class="container">
...
<script>
	$(document).ready(function() {
		'use strict';
    var slug = $('#slug').val();
    var authRoute = '{{route("contracting-authority",":id")}}'; 
    var authRoute = authRoute.replace(':id', slug);
      ...
      dom: 'frtip',
        ...
        },
        {
          data: 'Projects',
          render: function(data, type, row) {
            var url = '{{route("contracting-project-list",":id")}}'; 
