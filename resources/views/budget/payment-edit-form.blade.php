...
@section('title', 'Payment Edit Form')
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <div class="row gutters">
      ...
      <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
        ...
        {!! Form::open(array('route' =>['budget-payment.update',$single_data->id],'method'=>'PUT','files'=>true,'enctype'=>'multipart/form-data')) !!}
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="row gutters">
              ...
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                ...
                <div class="field-wrapper">
                  <div class="input-group">
                    <input type="number" class="form-control" value="{{$single_data->budget->contract_amount}}" readonly="">
                  </div>
              ...
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                ...
                <div class="field-wrapper">
                  <div class="input-group">
                    <input type="number" class="form-control" value="{{$single_data->budget->contract_amount - $single_data->budget->payment}}" onkeyup="paymentCheck(this.value, pay_amount.value)" id="due_amount" readonly="">
                  </div>
              ...
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                ...
                <div class="field-wrapper">
                  <div class="input-group">
                    <input type="number" step="any" name="pay_amount" id="pay_amount" value="{{($single_data->currency_type == 'USD')?($single_data->amount/$single_data->dollar_rate) : $single_data->amount}}" onkeyup="paymentCheck(due_amount.value ,this.value);currencyConvertion(dollar_rate.value,this.value)" class="form-control" required="" autocomplete="off">
                  </div>
              ...
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                ...
                <div class="field-wrapper">
                  <div class="input-group">
                    <input type="number" name="dollar_rate" id="dollar_rate" value="{{$single_data->dollar_rate}}" onkeyup="currencyConvertion(this.value ,pay_amount.value)" class="form-control" required="" autocomplete="off">
                  </div>
              ...
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                ...
                <div class="field-wrapper">
                  <div class="input-group">
                    <input type="number" name="bdt_amount" id="bdt_amount" value="{{$single_data->dollar_rate * $single_data->amount}}"  class="form-control" readonly="" autocomplete="off">
                  </div>
              ...
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                ...
                <div class="field-wrapper">
                  <div class="input-group">
                    <input type="date" name="date" class="form-control" value="{{$single_data->date}}" required="" autocomplete="off">
                  </div>
          ...
          <div class="card-footer">
           ...
           <a href="{{route('budget-payment-amendment')}}" class="btn btn-warning">Back</a>
          </div>
        </div>
        {!! Form::close() !!}
      </div>
