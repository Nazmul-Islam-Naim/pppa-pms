...
@section('title', 'Budget Payment Amendment')
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <div class="row gutters">
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
          <div class="card-header">
            <div class="card-title">Budget Payment Amendment</div>
          </div>
          <div class="card-body">
...
function filter_view(start_date = '',end_date = '') { 
  ...
  var table = $('#example').DataTable({
      ...
      deferRender : true,
			ajax: {
        url: "{{route('budget-payment-amendment')}}",
   ...
   $("#example").on("click", ".button-delete", function(e) {
			...
			var id = $(this).data('id');
			var url = '{{route("budget-payment.destroy",":id")}}';
