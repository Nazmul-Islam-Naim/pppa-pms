    ...
    <div class="row gutters">
      ...
      <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
        @if(!empty($single_data))
          {!! Form::open(array('route' =>['delivery-model.update', $single_data->id],'method'=>'PUT','files'=>true)) !!}
          <?php $info ="Update";?>
        @else
        {!! Form::open(array('route' =>['delivery-model.store'],'method'=>'POST','files'=>true)) !!}
          <?php $info ="Add";?>
        @endif
        <div class="card">
          <div class="card-header">
            <div class="card-title">{{$info}} Delivery Model </div>
          </div>
          <div class="card-body">
            <!-- Row start -->
            <div class="row gutters">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="actions" style="height: 25px">
                        <a href="{{ route('delivery-model.edit', $data->id) }}" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
                          <i class="icon-edit1 text-info"></i>
                        </a>
                        {{Form::open(array('route'=>['delivery-model.destroy',$data->id],'method'=>'DELETE'))}}
