...
@section('title', 'Implementing Agency')
@section('content')
    ...
    <div class="row gutters">
      ...
      <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
        @if(!empty($single_data))
          {!! Form::open(array('route' =>['implementing-agency.update', $single_data->id],'method'=>'PUT','files'=>true)) !!}
          <?php $info ="Update";?>
        @else
        {!! Form::open(array('route' =>['implementing-agency.store'],'method'=>'POST','files'=>true)) !!}
          <?php $info ="Add";?>
        @endif
        <div class="card">
          <div class="card-header">
            <div class="card-title">{{$info}} Implementing Agency</div>
          </div>
          <div class="card-body">
            <!-- Row start -->
            <div class="row gutters">
              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <div class="field-wrapper">
                  <div class="input-group">
                    <select name="ministry_id" class="form-control select-single js-states" data-live-search="true" requried="" autocomplete="off">
      ...
      <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
        <div class="card">
          <div class="card-header">
            <div class="card-title">Implementing Agency List</div>
          </div>
          <div class="card-body">
              ...
              <table id="basicExample" class="table custom-table">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>{{$sl++}}</td>
                    <td>{{$data->name}}</td>
                    <td>{{(!empty($data->ministry->name))?$data->ministry->name:'---'}}</td>
                    <td>{{$data->des}}</td>
                    <td>
                      @if($data->status == 1)
                    ...
                    <td>
                      <div class="actions" style="height: 25px">
                        <a href="{{ route('implementing-agency.edit', $data->id) }}" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
                          <i class="icon-edit1 text-info"></i>
                        </a>
                        {{Form::open(array('route'=>['implementing-agency.destroy',$data->id],'method'=>'DELETE'))}}
