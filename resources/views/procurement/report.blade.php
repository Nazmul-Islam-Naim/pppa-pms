      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card card-primary">
          <div class="card-header d-flex justify-content-between align-items-center">
              ...
              <a href="{{route('procurement-details.create')}}" class="btn btn-sm btn-primary"><i class="icon-plus-circle"></i>Add</a>
            </div>
          <!-- /.box-header -->
          <div class="card-body">
            <div class="row">
   ...
   function dateFormat(data) { 
	...
	$(document).ready(function() {
      ...
      var table = $('#example').DataTable({
			...
			processing: true,
      deferRender : true,
			ajax: "{{route('procurement-details.index')}}",
    ...
    $("#example").on("click", ".button-delete", function(e) {
			...
			var id = $(this).data('id');
			var url = '{{route("procurement-details.destroy",":id")}}';
